...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Client cli1 = new Client(null, "Marcos Paulo", "mprribeiro1902@gmail.com", "42158078609", ClientType.PERSON, pe.encode("123"), null);
		cli1.getPhones().addAll(Arrays.asList("12981162395", "1239668939"));
		
		Client cli2 = new Client(null, "Pâmela Rodrigues", "markos-santista@outlook.com", "12345678900", ClientType.PERSON, pe.encode("123"), null);
